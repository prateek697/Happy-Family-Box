...
class CitizenCartCompletedAdapterActivity(var context: Context, var ongoingList: MutableList<BookingCart>):
        RecyclerView.Adapter<CitizenCartCompletedAdapterActivity.DetailsViewHolder>() {
